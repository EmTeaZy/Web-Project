...
router.get("/createClassroom", ensureAuthenticated, (req, res) => res.render("createClassroom"));
router.get("/joinClassroom", ensureAuthenticated, (req, res) => res.render("joinClassroom"));
